...
\begin{figure}[H]
    \centering
    \missingfigure{Effect of regularization strength on semantics reward trajectories.}
    \caption{Effect of regularization strength on semantics reward trajectories.}
...
\begin{figure}[H]
    ...
    \caption{Effect of different post-suffixes.}
...
\begin{figure}[H]
    ...
    \caption{Effect of different text baselines on semantics reward trajectories.}
    \label{fig:baseline}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Effect of texturing and image operations on semantics reward trajectories.}
