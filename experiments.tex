...
\begin{figure}[H]
    \centering
    % \includegraphics[width=\textwidth]{images/grid_comparison_orange.png}
    % % \includegraphics[width=\textwidth]{images/grid_comparison_images.png}
    % \includegraphics[width=\textwidth]{images/grid_comparison_accuracy_orange.png}
    ...
    % \includegraphics[width=\textwidth]{images/grid_comparison_color.png}
    % % \includegraphics[width=\textwidth]{images/grid_comparison_images.png}
    % \includegraphics[width=\textwidth]{images/grid_comparison_accuracy_color.png}
    \caption{CLIP on sketches and ShapeGridWorld grids of different resolutions.}
    \label{fig:clip-sketches}
    % \includegraphics[width=\textwidth]{images/grid_comparison_inverted.png}
...
Unlike ShapeGridWorld, we found no clear trend in the effect of inversions on the performance of CLIP, but colors seemed to barely affect the semantic biases in the inferences in certain cases.
...
\begin{figure}[H]
    \centering
    \missingfigure{Trajectories with few categories vs many categories.}
...
\begin{figure}[H]
    \centering
    \missingfigure{For the previous four sections, it'll be a grid of plots for a range of \(\alpha\) and \(\beta\) values, with each plot in the grid showing the respective ablation plot from the figure below.}
    \includegraphics[width=\textwidth]{images/p_clip_hyperparams.png}
...
\begin{figure}[H]
    \centering
    \missingfigure{Heatmap over the combinations over the adversarial observations.}
    \includegraphics[width=\textwidth]{images/p_adversarial_histogram.png}
    \includegraphics[width=\textwidth]{images/p_adversarial_histogram_1.png}
    \missingfigure{Trajectories of the same CLIP parameters. Compare them to the previous ones from the closeness costs post hoc ablation studies.}
