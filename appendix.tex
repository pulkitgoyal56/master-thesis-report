...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{C{4.7cm} L C{2cm}}
        ...
        \texttt{elites\_size} & Size of the elite set, \(K\). See \eqref{eq:icem-filter}. & \(20\)\\
...
\begin{figure}[h]
    ...
    \caption[CLIP on different inversions of the same Tangram creation.]{CLIP on different inversions of the same Tangram creation (\(T = 0.1\)).}
