...
\todo{add staging images and link to the videos.}
% staging_crop.png
...
\figref{fig:categories-boxplot-sgw} and \figref{fig:categories-sgw} show the effect of different categories on the reward landscape and \figref{fig:categories-samples-sgw} shows some samples of the creations with different categories.
...
Without RaIR, the effect of categories on the reward landscape was different.
\figref{fig:categories-boxplot-sgw-norair} and \figref{fig:categories-sgw-norair} show the effect of different categories on the reward landscape and \figref{fig:categories-samples-sgw-norair} shows some samples of the creations with different categories.
